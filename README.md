...
- [SketchyBar](https://github.com/FelixKratz/SketchyBar)：系统菜单栏已经被隐藏，这条是它的替身。左边是 AeroSpace 的 9 个工作区加当前应用名，右边是音量和时间；rose-pine moon 配色，当前工作区高亮成和焦点框同一个蓝色，同样由 launchd agent 在登录时拉起
